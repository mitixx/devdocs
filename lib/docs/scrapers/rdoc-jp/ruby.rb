module Docs
  class Ruby < Rdoc
    ...
    version '2.5' do
      self.release = '2.5.0'
      self.dir = 'https://docs.ruby-lang.org/ja/2.5.0/doc/index.html'

    version '2.4' do
      self.release = '2.4.0'
      self.dir = 'https://docs.ruby-lang.org/ja/2.4.0/doc/index.html'
    end

    version '2.3' do
      self.release = '2.3.0'
      self.dir = 'https://docs.ruby-lang.org/ja/2.3.0/doc/index.html'
    end

    version '2.2' do
      self.release = '2.2.9'
      self.dir = 'https://docs.ruby-lang.org/ja/2.2.0/doc/index.html'
    end
  end
end
